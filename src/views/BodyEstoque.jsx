...
import BuscaEstoque from '../components/Estoque/BuscaEstoque';
import CadastroEstoque from '../components/Estoque/CadastroEstoque';

const drawerWidth = 240;

function BodyEstoque(props) {
    const { window } = props;
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                {ehConsulta ? (<BuscaEstoque/>) : <CadastroEstoque/>}
